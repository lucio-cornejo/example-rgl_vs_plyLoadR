...
patient0_FolderViews = FolderViews[1:5][1:3]
patient0_ViewsNames = ViewsNames[1:5][1:3]

patient1_FolderViews = FolderViews[-(1:5)][1:2]
patient1_ViewsNames = ViewsNames[-(1:5)][1:2]
```
...
plyLoadR(
  ...
  toggleWidgets = TRUE,
  toggleLabels = c(
    "2020-07-09", "2020-07-17", "2020-07-24"
  )
)
```
